class AlarmsController < ApplicationController
  ...
  def turn_on
    @alarms = current_user.alarms.find(params[:id])
    @alarms.turn=true
    @alarms.save
    redirect_to '/alarms/',notice: ""
  end
  ...
  private
    ...
    def alarm_params
      params.require(:alarm).permit(:time, :monday, :tuesday, :wednesday, :thursday, :friday, :saturday, :sunday, :message, :turn, :user_id)
    end
end
